...
CREATE INDEX COMTNBBS_i01 ON COMTNBBS (BBS_ID  ASC);
...
CREATE INDEX COMTNCOMMENT_i01 ON COMTNCOMMENT (NTT_ID  ASC,BBS_ID  ASC);
...
CREATE INDEX COMTNCLUBUSER_i01 ON COMTNCLUBUSER (CLB_ID  ASC,CMMNTY_ID  ASC);
...
CREATE INDEX COMTNCMMNTYUSER_i01 ON COMTNCMMNTYUSER (CMMNTY_ID  ASC);
...
CREATE TABLE COMTNQUSTNRTMPLAT (
	...
	LAST_UPDT_PNTTM       DATE  NULL,
	LAST_UPDUSR_ID        VARCHAR2(20)  NULL,
	QUSTNR_TMPLAT_IMAGE_INFO  LONG VARBINARY  NULL,
...
CREATE INDEX COMTNNCRDUSER_i03 ON COMTNNCRDUSER (NCRD_ID  ASC);
...
CREATE INDEX COMTNBBSUSE_i01 ON COMTNBBSUSE (BBS_ID  ASC);

CREATE TABLE COMTNSTPLATINFO (
	USE_STPLAT_ID         CHAR(20)  NOT NULL,
	USE_STPLAT_NM         VARCHAR2(100)  NULL,
	USE_STPLAT_CN         LONG VARCHAR  NULL,
	INFO_PROVD_AGRE_CN    LONG VARCHAR  NULL,
	FRST_REGIST_PNTTM     DATE  NULL,
	FRST_REGISTER_ID      VARCHAR2(20)  NULL,
	LAST_UPDT_PNTTM       DATE  NULL,
	LAST_UPDUSR_ID        VARCHAR2(20)  NULL,
...
CREATE INDEX COMTNADBK_i01 ON COMTNADBK (ADBK_ID  ASC);
...
CREATE TABLE COMTNONLINEMANUAL (
	...
	ONLINE_MNL_DFN        LONG VARCHAR  NULL,
	ONLINE_MNL_DC         LONG VARCHAR  NULL,
	FRST_REGISTER_ID      VARCHAR2(20)  NULL,
	FRST_REGIST_PNTTM     DATE  NULL,
	LAST_UPDUSR_ID        VARCHAR2(20)  NULL,
	LAST_UPDT_PNTTM       DATE  NULL,
...
CREATE INDEX COMTNSMSRECPTN_i01 ON COMTNSMSRECPTN (SMS_ID  ASC);
...
CREATE INDEX COMTNDIARYINFO_i01 ON COMTNDIARYINFO (SCHDUL_ID  ASC);
...
CREATE INDEX COMTNNEWSINFO_i01 ON COMTNNEWSINFO (ATCH_FILE_ID  ASC);
...
CREATE INDEX COMTNCNTCMESSAGEITEM_i01 ON COMTNCNTCMESSAGEITEM (CNTC_MSSAGE_ID  ASC);
...
CREATE INDEX COMTNNOTETRNSMIT_i01 ON COMTNNOTETRNSMIT (NOTE_ID  ASC);
...
CREATE INDEX COMTNNOTERECPTN_i01 ON COMTNNOTERECPTN (NOTE_ID  ASC,NOTE_TRNSMIT_ID  ASC);
...
CREATE INDEX COMTNEVENTATDRN_i01 ON COMTNEVENTATDRN (EVENT_ID  ASC);

CREATE TABLE IMGTEMP (
	ORGNZT_CODE           VARCHAR2(10)  NOT NULL,
	ERNCSL_SE             VARCHAR2(2)  NOT NULL,
	IMAGE_INFO            LONG VARBINARY  NOT NULL,
...
CREATE TABLE COMTNWIKMNTHNGREPRT (
	...
	THSWIK_REPORT_CN      LONG VARCHAR  NOT NULL,
	NEXTWIK_REPORT_CN     LONG VARCHAR  NOT NULL,
	PARTCLR_MATTER        VARCHAR2(2500)  NULL,
	ATCH_FILE_ID          CHAR(20)  NULL,
...
CREATE INDEX COMTNMTGPLACEFXTRS_i01 ON COMTNMTGPLACEFXTRS (MTGRUM_ID  ASC);
